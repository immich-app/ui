  ...
  <div class="mx-auto max-w-(--breakpoint-lg) xl:py-8">
    <Stack gap={8}>
      <div class="place-center grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-5">
        <Stack>
          <Heading size="small" class="mb-3">Social</Heading>
        ...
        <Stack>
          <Heading size="small" class="mb-3">Download</Heading>
        ...
        <Stack>
          <Heading size="small" class="mb-3">Company</Heading>
        ...
        <Stack>
          <Heading size="small" class="mb-3">Sites</Heading>
        ...
        <Stack>
          <Heading size="small" class="mb-3">Miscellaneous</Heading>
